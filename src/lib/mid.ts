/** Maritime Identification Digits: first three digits of an MMSI → flag state. */
export const MID_TO_FLAG: Record<string, string> = {
  ...
  "305": "Antigua & Barbuda", "306": "Curacao", "307": "Aruba", "308": "Bahamas",
  ...
  "374": "Panama", "375": "St Vincent & Grenadines", "376": "St Vincent & Grenadines",
  ...
  "466": "Qatar", "468": "Syria", "470": "United Arab Emirates",
  "471": "United Arab Emirates", "472": "Tajikistan", "473": "Yemen",
  "475": "Yemen", "477": "Hong Kong", "478": "Bosnia & Herzegovina",
  "501": "Antarctica (FR)", "503": "Australia", "506": "Myanmar", "508": "Brunei",
  ...
  "634": "Kenya", "635": "Antarctica (FR)", "636": "Liberia", "637": "Liberia",
  ...
  "664": "Rwanda", "665": "Sudan", "666": "South Sudan", "667": "Sierra Leone",
  "668": "Sao Tome & Principe", "669": "Eswatini", "670": "Chad", "671": "Togo",
  "672": "Tunisia", "674": "Tanzania", "675": "Uganda", "676": "DR Congo",
  "677": "Tanzania", "678": "Zambia", "679": "Zimbabwe", "701": "Argentina",
  "710": "Brazil", "720": "Bolivia", "725": "Chile", "730": "Colombia",
  "735": "Ecuador", "740": "Falkland Islands", "745": "French Guiana",
  "750": "Guyana", "755": "Paraguay", "760": "Peru", "765": "Suriname",
  "770": "Uruguay", "775": "Venezuela",
};

export function flagFromMmsi(mmsi: string | number): string {
  const s = String(mmsi).padStart(9, "0");
  return MID_TO_FLAG[s.substring(0, 3)] ?? "Unknown";
}
